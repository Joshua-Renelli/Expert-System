...
if (process.env.NODE_ENV === 'production'){
    ...
    serviceAccount = {
        ...
        "project_id": "expert-system-50e65",
        ...
        "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-ot0ba%40expert-system-50e65.iam.gserviceaccount.com"
      }
} else {
    serviceAccount = require('../expert-system-50e65-firebase-adminsdk-ot0ba-8e9b063ac7.json');
}
